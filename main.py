...
def generer_pdf(data: ConsentementData):
    ...
    # Traitement de la signature : ajout d’un fond blanc pour éviter les rectangles noirs
    try:
        ...
        white_bg.paste(pil_image.convert("RGBA"), (0, 0), pil_image.convert("RGBA"))

        signature_buffer = BytesIO()
        white_bg.save(signature_buffer, format="JPEG")
